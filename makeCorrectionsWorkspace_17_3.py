...
#    (loc+'/ZmmTP_DY_Fits_Trg_AIso1_pt_bins_inc_eta.root:Trg_AIso1_pt_bins_inc_eta',              'm_trg_aiso1_mc'),
#    (loc+'/ZmmTP_Data_Fits_Trg_AIso2_pt_bins_inc_eta.root:Trg_AIso2_pt_bins_inc_eta',                    'm_trg_aiso2_data'),
#    (loc+'/ZmmTP_DY_Fits_Trg_AIso2_pt_bins_inc_eta.root:Trg_AIso2_pt_bins_inc_eta',              'm_trg_aiso2_mc')
    ]
